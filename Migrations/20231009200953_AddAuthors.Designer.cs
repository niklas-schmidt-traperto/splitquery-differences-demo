...
namespace PoCSplitQueries.Migrations
{
    ...
    [Migration("20231009200953_AddAuthors")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoCSplitQueries.Models.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("PoCSplitQueries.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PoCSplitQueries.Models.Book", null)
                        .WithMany()
